/**
 * Documentation: {@link https://greensock.com/docs/v3/Plugins}
 *
 * TRL provides all the GSAP plugins available and makes it easy to install them via simply using a side effect import.
 * The plugin will be automatically loaded and enabled in GSAP without any additional hook up concerns.
 *
