/**
 * Documentation: {@link https://greensock.com/docs/v3}
 *
 * Provides automatic hookup and initialization of GSAP. There are several unique resources available in this sub-path
 * export that makes GSAP even easier to use including support for `TJSPosition`. In particular, {@link GsapCompose}
